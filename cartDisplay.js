...
let noItem='<p class="empty-cart">Your cart is empty.</p><button   class="view-product">View products</button>';
if(producthtmlcart===''){
...
buttons.forEach((button)=>{
  ...
  document.querySelector('.js-total-cost').innerHTML=`$${((taxCalculation+(taxCalculation*0.1))/100).toFixed(2)}`;
  itemsCost=0;
  cartCount=0;
}
}
